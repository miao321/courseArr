...
<div class="top1">
    <marquee scrollAmount=2 width=300>犯我中华者  虽远必诛</marquee>
</div>
<div class="top2">
    <div class="logo">
...
<div class="left">
    <div class="div1">
        ...
        <div class="div3">
            <ul>
                <li><a class="a" href="javascript:void(0);"
                       onClick="openurl('addCourse.jsp');">添加课程</a></li>
                <li><a class="a" href="javascript:void(0);"
                       onClick="openurl('SelectCourseServlet');">查看课程</a></li>
                <li><a class="a" href="javascript:void(0);"
                       onClick="openurl('delCourse.jsp');">删除课程</a></li>
        ...
        <div class="div3">
            <ul>
                 <li><a class="a" href="javascript:void(0);"
                       onClick="openurl('SelectUserServlet');">管理员管理</a></li> 
                <!--  <li><a class="a" href="SelectUserServlet "
                       >管理员管理</a></li> -->
                <li><a class="a" href="javascript:void(0);"
                       onClick="openurl('changePassword.jsp');">修改密码</a></li>
            </ul>
        </div>
        ...
        <div class="div3">
            ...
            <ul>
                <li><a class="a" href="javascript:void(0);"
                       onClick="openurl('review_verify.php');">主页评价审核</a></li>
                <li><a class="a" href="javascript:void(0);"
                       onClick="openurl('user_review_verify.php');">列表评价审核</a></li>
            </ul>
